...
//					float fValue = ((float)field.get(this.getValue(i, j))) / minValue;
	 ...
	 * @throws NoSuchMethodException 
	 */
	private MathObject calculMineur(int deleteLigne, int deleteColonne){
		try {
			MatrixExceptionControler.controleSquareMatrix(this);
	 ...
	 * @throws NoSuchMethodException 
	 */
	private MathObject calculCofacteur(int deleteLigne, int deleteColonne){
	 ...
	 * @throws NoSuchMethodException 
	 */
	private Matrice calculComatrice(){
		try {
			MatrixExceptionControler.controleSquareMatrix(this);
	 ...
	 * @throws NoSuchMethodException 
	 */
	public List<MathObject> valeurPropre(){
	...
	public List<Matrice> vecteurPropre(){
	...
	public List<Matrice> vecteurPropreNewGen(){
		List<Matrice> resultat = new ArrayList<Matrice>();
	 ...
	 * @throws NoSuchMethodException 
	 */
	public Matrice multiplyLigneByScalaire(MathObject scalaire, int ligne) {
		Matrice matriceRetour = new Matrice(this.nb_ligne, this.nb_col);
