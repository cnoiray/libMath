...
import math.service.OperationService;
...
public class Polynome extends MathObject{
	...
	private static OperationService service = new OperationService();
	 ...
	 */
	public Polynome buildPolynomeFromFactoriseForm(List< List<MathObject>> formeFactorisee) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
	 ...
	 * @throws NoSuchMethodException 
	 */
	private List<MathObject> developperNaif(List<List<MathObject>> formeFactorisee) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		List<MathObject> formeDeveloppee = new ArrayList<MathObject>();
		for(List<MathObject> facteur: formeFactorisee){
			if(formeDeveloppee.size() == 0){
				formeDeveloppee = facteur;
			}else{
				formeDeveloppee = service.multiplicationPolynome(facteur, formeDeveloppee);
			}
		}
	 ...
	 * @throws NoSuchMethodException 
	 */
	public Polynome deriver() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		List<MathObject> formeDeveloppee = new ArrayList<MathObject>();
		int i;
	 ...
	 * @throws NoSuchMethodException 
	 */
	public Polynome calculDeriveeN(int degres) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		List<MathObject> formeDeveloppee = new ArrayList<MathObject>();
		int i, j;
		int facteur;
