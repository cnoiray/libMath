...
import math.controler.exception.DiagonalMatriceErrorException;
import math.controler.exception.DivisionByZeroException;
import math.controler.exception.LinearEquationException;
...
public class SystemeEquation extends MathObject{
	 ...
	 */
	public Matrice resolutionEquationLineaire() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		if(this.isHomogene() && 
	 ...
	 * @throws NoSuchMethodException 
	 */
	public void multiplyLineByScalaire(int ligne, MathObject scalaire) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
	 ...
	 * @throws NoSuchMethodException 
	 */
	public void addLigneAndScalaire(int ligne1, int ligne2, MathObject polyme) throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		int j;
		//pour la matrice de transformation
	 ...
	 * @throws NoSuchMethodException 
	 */
	public Matrice cramerResolution() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
		try {
	 ...
	 * @throws NoSuchMethodException 
	 */
	public MathObject matrixInversionResolution() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
	 ...
	 * @throws NoSuchMethodException 
	 */
	public Matrice pivotGaussResolution() throws NoSuchMethodException, SecurityException, IllegalAccessException, IllegalArgumentException, InvocationTargetException{
